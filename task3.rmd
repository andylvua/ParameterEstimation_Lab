### Problem 3.The expected value of the exponential distribution E (λ) is 1/λ, so that a good point estimate of the parameter θ := 1/λ is the sample mean x. Confidence interval for θ can be formed in several different ways
